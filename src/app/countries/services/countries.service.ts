...
import { Country, Region, SmallCountry } from '../interfaces/region.interfaces';
...
export class CountriesService {
  ...
  public getCountriesByBorders(borders: string[]): Observable<SmallCountry[]>{
